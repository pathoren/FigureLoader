...
class ScriptEditor(stc.StyledTextCtrl):
    ...
    def __init__(self, parent, ID,
        ...
        self.Bind(stc.EVT_STC_UPDATEUI, self.update_UI)
...
class ScriptPanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.ed = ScriptEditor(self, -1)

        self.btn_save = wx.Button(self, -1, 'Save')
        self.btn_load = wx.Button(self, -1, 'Load')
        self.btn_run = wx.Button(self, -1, 'Run')
        self.btn_reload = wx.Button(self, -1, 'Reload fig')

        s1 = wx.BoxSizer(wx.HORIZONTAL)
        s1.Add(self.btn_save, 1, wx.EXPAND)
        s1.Add(self.btn_load, 1, wx.EXPAND)
        s1.Add(self.btn_run, 1, wx.EXPAND)
        s1.Add(self.btn_reload, 1, wx.EXPAND)
...
class CpFrame(wx.Frame):
    """
    Class for test runs of the GUI..
    """
    def __init__(self):
        wx.Frame.__init__(self, None, - 1, title='Editor', pos=(wx.DisplaySize()[0]/2,0))
        self.panel = ScriptPanel(self) 
        szr = wx.BoxSizer(wx.HORIZONTAL)
        szr.Add(self.panel, 1, wx.ALL|wx.EXPAND, 0)
        self.SetSizer(szr)
        self.Layout()
